...
<html lang="en">
  ...
  <body class="goto-here">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">0812345678</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">fadlan@email.com</span>
					    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        @endphp
	      <a class="navbar-brand" href="index.html">{{ $about->judul_website }}</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="/stores/buah">Fruits</a>
              	<a class="dropdown-item" href="/stores/sayur">Vegetables</a>
              </div>
            </li>
            @if (Auth::guard('webcustomer')->check())
            ...
            @else
	          <li class="nav-item"><a href="/login_customer" class="nav-link">Login</a></li>
	          <li class="nav-item"><a href="/register_customer" class="nav-link">Register</a></li>
            @endif
	        </ul>
	      </div>
	    </div>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Freshpick Corner</h2>
