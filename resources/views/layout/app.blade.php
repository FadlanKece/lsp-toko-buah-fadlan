...
<head>
    ...
    <title>Dashboard Freshpickcorner</title>
    <!--     Fonts and icons     -->
...
<body class="g-sidenav-show bg-gray-200">
    <aside
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-white {{ (Request::is('dashboard') ? 'active' : '') ? 'active bg-gradient-primary' : '' }}"
                        href="/dashboard">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white {{ (Request::is('barang') ? 'active' : '') ? 'active bg-gradient-primary' : '' }}"
                        href="/barang">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <ul class="navbar-nav justify-content-end">
                        ...
                        <li class="nav-item d-flex align-items-center">
                            <a href="/dashboard" class="nav-link text-body font-weight-bold px-0">
                                ...
                                <span class="d-sm-inline d-none">{{ Auth::guard('web')->user()->name }}</span>
                            </a>
                        </li>
                    </ul>
                </div>
