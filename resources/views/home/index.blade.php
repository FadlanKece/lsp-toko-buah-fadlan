  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 col-lg-3 ftco-animate">
        ...
        @endphp
        <div class="product">
          <a href="/store/{{ $product->id }}" class="img-prod"><img class="img-fluid" src="/uploads/{{ $product->foto1 }}" alt="Colorlib Template">
            @if ($discount)
          ...
          <div class="text py-3 pb-4 px-3 text-center">
            <h3><a href="/store/{{ $product->id }}">{{ $product->product_name }}</a></h3>
            <div class="d-flex">
              <div class="pricing">
                @if ($discount)
                <p class="price"><span class="mr-2 price-dc">RP {{ number_format($product->price) }}</span><span class="price-sale">RP {{ number_format($product->price * (1 - $discount->percentage / 100)) }}</span></p>
                @else
